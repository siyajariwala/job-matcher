...
I was deep in AI engineer interview prep, learning embeddings, vector search, and cosine similarity for the first time. Rather than just reading theory, I wanted to build something small and real with it — this tool was that exercise. It's intentionally simple: no database, no auth, just the core concept working end to end.
